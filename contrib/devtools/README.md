...
Provides utilities for managing copyright headers of `The sQuorum
...
sQuorum-Project/sQuorum repository.
...
Configuring the github-merge tool for the sQuorum repository is done in the following way:
    ...
    git config githubmerge.repository sQuorum-Project/sQuorum
