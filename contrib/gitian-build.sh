...
VERSION=
commit=false
url=https://github.com/gjhiggins/diproton
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/gjhiggins/diproton
...
then
    ...
    git clone https://github.com/gjhiggins/diproton/gitian.sigs.git
    git clone https://github.com/gjhiggins/diproton/helium-detached-sigs.git
    git clone https://github.com/gjhiggins/diproton/gitian-builder.git
