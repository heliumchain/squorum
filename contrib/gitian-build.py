...
def setup_repos():
    ...
    if not os.path.isdir('squorum-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/heliumchain/squorum-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('squorum'):
        subprocess.check_call(['git', 'clone', 'https://github.com/heliumchain/squorum.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/heliumchain/squorum', help='Specify the URL of the repository. Default is %(default)s')
