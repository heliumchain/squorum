...
In order to support loading of multiple wallets in helium-qt, a few changes in the UI architecture will be needed.
...
----------------------
helium.cpp is the entry point into helium-qt, and as such, will require some minor modifications to provide hooks for
