...
sQuorum Core v3.0.2 is a recommended, semi-mandatory update for all users. This release contains transaction creation bug fixes for zHLM spends, automint calculation adjustments, and other various updates/fixes.
...
- #292 `feadab4` Additional checks for double spending of zSqr serials. (presstab)
...
- #280 `fdc182d` [Wallet] Fix zSqr spending errors. (presstab)
- #282 `310f216` [Wallet] Count pending zSqr balance for automint. (presstab)
...
- #291 `cb314e6` [Qt] zSqr control quantity/amount fixes (rejectedpromise)
