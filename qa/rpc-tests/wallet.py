...
#   c) node1 mines 32 blocks, so now node 0 has 60001hlm, node 1 has 4250hlm, node2 has none.
#   d) node0 sends 601 hlm to node2, in two transactions (301 hlm, then 300 hlm).
