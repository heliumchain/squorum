...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-backupzhlm=<n>", strprintf(_("Enable automatic wallet backups triggered after each zHelium minting (0-1, default: %u)"), 1));
...
// ********************************************************* Step 8: load wallet
    ...
    if (fDisableWallet) {
        ...
        bool fEnableZHeliumBackups = GetBoolArg("-backupzhlm", true);
        pwalletMain->setZHeliumAutoBackups(fEnableZHeliumBackups);
    }  // (!fDisableWallet)
#else  // ENABLE_WALLET
