...
bool CWalletDB::WriteZHLMSeed(const uint256& hashSeed, const std::vector<unsigned char>& seed)
{
...
bool CWalletDB::ReadZHLMSeed(const uint256& hashSeed, std::vector<unsigned char>& seed)
{
