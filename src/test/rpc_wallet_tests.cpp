...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    BOOST_CHECK_THROW(CallRPC("setaccount STDrwM7dDmaJxR1mW1e56TZtNtM6PHfjHB nullaccount"), std::runtime_error);
    ...
    BOOST_CHECK_THROW(CallRPC("signmessage STDrwM7dDmaJxR1mW1e56TZtNtM6PHfjHB mymessage"), std::runtime_error);
    ...
    /* Illegal address */
    BOOST_CHECK_THROW(CallRPC("verifymessage STDrwM7dDmaJxR1mW1e56TZtNtM6PHfjH " + retValue.get_str() + " mymessage"), std::runtime_error);
    /* wrong address */
