...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextHelium = QChar(0xA9) + QString(" 2018-2020 ") + QString(tr("The Helium Core developers"));
    QString copyrightTextsQuorum = QChar(0xA9) + QString(" 2020-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The sQuorum Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 48, copyrightTextsQuorum);
