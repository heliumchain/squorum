...
void OverviewPage::getPercentage(CAmount nUnlockedBalance, QString& sHLMPercentage)
{
    int nPrecision = 2;
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    // Combined balances
    CAmount availableTotalBalance = hlmAvailableBalance;
    ...
    ui->labelPendingText->setVisible(showHLMPending || showWatchOnlyPIVPending);
    ui->labelUnconfirmed->setVisible(showHLMPending || showWatchOnlyPIVPending);
