...
do
convert helium-1024x1024.png -resize ${b}x${b} icon_${b}x${b}.png
# *Should* be:
# convert helium-1024x1024.png -unsharp 0 -resize $((b*2))x$((b*2)) icon_${b}x${b}@2x.png
...
cp helium-1024x1024.png icon_512x512@2x.png
...
rm -f icon_* helium-1024x1024.png
