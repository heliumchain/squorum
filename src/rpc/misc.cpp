...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            "validateaddress \"squorumaddress\"\n"
            "\nReturn information about the given squorum address.\n"
            ...
            "  \"address\" : \"squorumaddress\", (string) The squorum address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw std::runtime_error(
            "verifymessage \"squorumaddress\" \"signature\" \"message\"\n"
